                    ...
                    <div class="row">
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        <ul class="pagination pagination-split">
                          <h2>Total <b>{{ count($alumni) }}</b> ditemukan, pencarian dari kata <b>{{ $_GET['kata'] }}</h2>
                        </ul>
                      </div>
                        ...
                        <div class="well profile_view">
                          ...
                          <div class="col-xs-12 bottom">
                            ...
                            <div class="col-xs-12 col-sm-6 emphasis">
                              ...
                              <a type="button" href="{{ url('/admin/alumni/del/' . $a->id . '/' .str_slug($a->nama, '-')) }}" class="btn btn-danger btn-xs">
